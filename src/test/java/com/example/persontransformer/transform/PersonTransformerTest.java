...
class PersonTransformerTest {
    ...
    @Test
    void transform_withRaceAndEthnicity_mapsAndTrims() {
    ...
    @Test
    void transform_withNullRaceAndEthnicity_mapsNulls() {
        PersonEvent event = new PersonEvent("ext-1", "Jane", "Doe", "jane@example.com");
        Person person = transformer.transform(event);
    ...
    void personEvent_containsRaceAndEthnicity() {
        // Ensure race and ethnicity fields exist in PersonEvent
    ...
    void person_containsRaceAndEthnicity() {
        // Ensure race and ethnicity fields exist in Person domain model
    ...
    void applyToExisting_withRaceAndEthnicity_updatesFields() {
        ...
        existing.setEthnicity("NonHispanic");
    ...
    void applyToExisting_withNullRaceInEvent_keepsExistingRace() {
        ...
        assertThat(existing.getEthnicity()).isEqualTo("NonHispanic");
    }
