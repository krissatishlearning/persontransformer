...
class PersonTransformerTest {
    ...
    @Test
    void transform_withRaceAndEthnicity_trimsAndStoresValues() {
    ...
    @Test
    void transform_withAllFieldsIncludingRaceAndEthnicity_transformsCorrectly() {
        List<AddressDTO> addressDTOs = Collections.singletonList(
