...
class PersonTransformerTest {
    ...
    @Test
    void transform_containsRaceAndEthnicity() {
    ...
    void transform_mapsRaceAndEthnicity() {
        PersonEvent event = new PersonEvent("ext-1", "Jane", "Doe", "jane@example.com", "Asian", "Not Hispanic");
        Person person = transformer.transform(event);
    ...
    @Test
    void transform_withNullRaceAndEthnicity_setsNulls() {
    ...
    void applyToExisting_updatesRaceAndEthnicity() {
        ...
        PersonEvent event = new PersonEvent("ext-1", "Old", "Name", "old@x.com", "Asian", "Not Hispanic");
        transformer.applyToExisting(existing, event);
