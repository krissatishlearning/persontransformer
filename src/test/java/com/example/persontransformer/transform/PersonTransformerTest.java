...
class PersonTransformerTest {
    ...
    @Test
    void transform_personEventContainsRaceAndEthnicity() {
    ...
    @Test
    void transform_personDomainContainsRaceAndEthnicity() {
        // Verify Person domain model has race and ethnicity fields
