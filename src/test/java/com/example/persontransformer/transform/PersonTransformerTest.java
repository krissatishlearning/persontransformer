...
class PersonTransformerTest {
    ...
    @Test
    void transform_withRaceAndEthnicity_mapsToPersonDomain() {
    ...
    @Test
    void transform_withRaceAndEthnicityWithWhitespace_trimsThem() {
        PersonEvent event = new PersonEvent("ext-1", "Jane", "Doe", "jane@example.com",
    ...
    @Test
    void transform_withNullRaceAndEthnicity_storesNulls() {
        PersonEvent event = new PersonEvent("ext-1", "Jane", "Doe", "jane@example.com");
        Person person = transformer.transform(event);
    ...
    @Test
    void transform_raceAndEthnicityFieldsExistInPersonDomain() {
    ...
    @Test
    void transform_raceAndEthnicityFieldsExistInPersonEvent() {
