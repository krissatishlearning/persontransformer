...
class PersonTransformerTest {
    ...
    void transform_mapsRaceAndEthnicity() {
        PersonEvent event = new PersonEvent("ext-1", "Jane", "Doe", "jane@example.com", "Asian", "Not Hispanic", null, null);
        Person person = transformer.transform(event);
    ...
    @Test
    void transform_withNullRaceAndEthnicity_personsFieldsAreNull() {
    ...
    void transform_trimsRaceAndEthnicity() {
        PersonEvent event = new PersonEvent("ext-1", "Jane", "Doe", "jane@example.com", "  White  ", "  Hispanic  ", null, null);
        Person person = transformer.transform(event);
    ...
    void applyToExisting_updatesRaceAndEthnicity() {
        ...
        existing.setEthnicity("Not Hispanic");

        PersonEvent event = new PersonEvent("ext-1", "Old", "Name", "old@x.com", "White", "Hispanic", null, null);
        transformer.applyToExisting(existing, event);
    ...
    @Test
    void applyToExisting_setsRaceAndEthnicityWhenExistingIsNull() {
        Person existing = new Person("mongo-id", "ext-1", "Old", "Name", "old@x.com", null);

        PersonEvent event = new PersonEvent("ext-1", "Old", "Name", "old@x.com", "Black", "Not Hispanic", null, null);
        transformer.applyToExisting(existing, event);
